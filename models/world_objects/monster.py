...
class Monster(GameObject):
    def __init__(self, position, rotation, sprite_name, max_hp, agr_range = 3, freeze_rotation_at = None, updates_to_move = 1):
        """
        Монстр
        ...
        """
        super().__init__(position, rotation, images_operator.get_image_path_from_monster_name(sprite_name))
        self.max_hp = max_hp
